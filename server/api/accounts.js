...
internals.applyRoutes = function (server, next) {
    ...
    const Account = require('../models/CouchAccount');
        //server.plugins['hapi-mongo-models'].Account;
    const User = server.plugins['hapi-mongo-models'].User;
    const Status = require('../models/CouchStatus');
        //server.plugins['hapi-mongo-models'].Status;
    ...
    server.route({
        ...
        handler: function (request, reply) {
            ...
            Account.pagedFind(query, fields, sort, limit, page, (err, results) => {
                ...
                console.log("All accounts:::: ", results);
                reply(results);
            });
        }
    });
    ...
    server.route({
        ...
        handler: function (request, reply) {
            ...
            Account.findById(request.params.id, (err, account) => {
                ...
                console.log("GOT ACCOUNT: " +  request.params.id + " :::: ", account);
                reply(account);
            });
        }
    });
